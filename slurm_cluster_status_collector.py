...
class SlurmClusterStatusCollector(Collector):
  ...
  def collect(self):
    try:
      ...
      lsload.add_metric(["cpuload"],CPULoad,precision=2)
      ...
      lsload.add_metric(["peralloc"],PerAlloc,precision=2)
      ...
      lsload.add_metric(["umemhaswell"],umem['haswell'],precision=0)
      lsload.add_metric(["umembroadwell"],umem['broadwell'],precision=0)
      lsload.add_metric(["umemskylake"],umem['skylake'],precision=0)
      lsload.add_metric(["umemmilan"],umem['milan'],precision=0)
      lsload.add_metric(["umemrome"],umem['rome'],precision=0)
      lsload.add_metric(["umemcascadelake"],umem['cascadelake'],precision=0)
      lsload.add_metric(["umemicelake"],umem['icelake'],precision=0)
      lsload.add_metric(["tcputres"],tcputres,precision=1)
      lsload.add_metric(["tgputres"],tgputres,precision=1)
      lsload.add_metric(["tmemtres"],tmemtres,precision=1)
      lsload.add_metric(["ucputres"],ucputres,precision=1)
      lsload.add_metric(["ugputres"],ugputres,precision=1)
      lsload.add_metric(["umemtres"],umemtres,precision=1)
      lsload.add_metric(["ttres"],ttres,precision=1)
      lsload.add_metric(["utres"],utres,precision=1)
      lsload.add_metric(["tcgflops"],tcgflops,precision=1)
      lsload.add_metric(["tggflops"],tggflops,precision=1)
      lsload.add_metric(["ucgflops"],ucgflops,precision=1)
      lsload.add_metric(["uggflops"],uggflops,precision=1)
      lsload.add_metric(["tgflops"],tgflops,precision=1)
      lsload.add_metric(["ugflops"],ugflops,precision=1)
